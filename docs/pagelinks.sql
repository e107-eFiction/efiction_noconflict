...
(3, 'login', 'Login', 'author.php?action=login', '0', 0),
(4, 'adminarea', 'Admin', 'admin.php', '0', 2),
(5, 'logout', 'Logout', 'author.php?action=logout', '0', 1),
...
(15, 'contactus', 'Contact Us', 'report.php', '0', 0),
...
(19, 'login', 'Account Info', 'author.php', '0', 1),
(20, 'titles', 'Titles', 'browse.php?type=titles', '0', 0),
(21, 'register', 'Register', 'author.php?action=register', '0', 0),
(22, 'lostpassword', 'Lost Password', 'author.php?action=lostpassword', '0', 0),
