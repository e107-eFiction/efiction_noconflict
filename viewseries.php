...
if(isMEMBER && $favorites) {
	$addtofaves = "[<a href=\"author.php?action=favse&amp;uid=".USERUID."&amp;add=$seriesid\">"._ADDSERIES2FAVES."</a>]";
	$jumpmenu .= "<option value=\"author.php?action=favse&amp;uid=".USERUID."&amp;add=$seriesid\">"._ADDSERIES2FAVES."</option>";
	if($series['isopen'] == 0) { // Only closed series.
		$addtofaves .= " [<a href=\"author.php?action=favau&amp;uid=".USERUID."&amp;add=".$series['uid']."\">"._ADDAUTHOR2FAVES."</a>]";
		$jumpmenu .= "<option value=\"author.php?action=favau&amp;uid=".USERUID."&amp;add=".$series['uid']."\">"._ADDAUTHOR2FAVES."</option>";
	}
}
